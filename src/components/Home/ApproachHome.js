    ...
    <section id="approach" className="approach-section section">
      ...
      <div className='approach-content'>
        ...
        <div className="approach-graphic">
          <div className='approach-team team-1 approach-background grid1-linear-gradient'>
            <img className='team-img' src={attorney} alt=''/>
            <p className='team-copy'>Attorneys providing free legal representation</p>
          </div>
          <div className='approach-team team-2 approach-background grid2-linear-gradient'>
            <img className='team-img' src={socialworker} alt=''/>
            <p className='team-copy'>Social Workers providing clinical expertise</p>
          </div>
          <div className='approach-team team-3 approach-background grid3-linear-gradient'>
      ...
      <div className='approach-content approach-content-bottom darkblue-linear-gradient'>
